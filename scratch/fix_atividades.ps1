    ...
    <div className="space-y-5">
      ...
      <Dialog open={presencaOpen} onOpenChange={setPresencaOpen}>
        <DialogContent className="rounded-2xl border-border/30">
          <DialogHeader><DialogTitle>Presença - {presencaItem?.nome}</DialogTitle></DialogHeader>
...
$content | Set-Content 'c:\Users\Toshiba\Desktop\Projetos no Antigravity\projeto catequese no lovable\src\pages\AtividadesList.tsx' -Encoding utf8
