  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 scrollbar-hide">
        ...
        <div className="pt-3">
          <button onClick={() => setShowSuggestionDialog(true)} className="w-full flex items-center gap-3 px-4 py-4 rounded-2xl bg-white dark:bg-zinc-900 transition-all duration-300 border-2 border-black/25 dark:border-white/20 shadow-md hover:shadow-lg hover:border-primary/50 active:scale-[0.98] group">
        ...
        <div className="pt-3">
          <button 
             ...
             className="w-full flex items-center gap-3 px-4 py-4 rounded-2xl bg-white dark:bg-zinc-900 transition-all duration-300 border-2 border-black/25 dark:border-white/20 shadow-md hover:shadow-lg hover:border-primary/50 active:scale-[0.98] group"
           >
