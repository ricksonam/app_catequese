...
import { HeadphonesIcon, FileUp, UploadCloud, AlertCircle } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[500px] rounded-[32px] p-6 sm:p-8 border-none shadow-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="mb-4">
          ...
          <DialogDescription className="text-center text-base">
            Como podemos ajudar você hoje? Selecione o tipo de atendimento e preencha os dados abaixo.
          </DialogDescription>
        </DialogHeader>
