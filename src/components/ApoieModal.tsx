...
export function ApoieModal({ open, onOpenChange }: ApoieModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-sm mx-auto rounded-[32px] p-0 border-none overflow-hidden shadow-2xl">
        {/* Background gradiente animado */}
        <div className="relative bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 dark:from-zinc-900 dark:via-zinc-800 dark:to-amber-950">
          {/* Orbs decorativos */}
          ...
          <div className="relative z-10 flex flex-col items-center gap-5 p-7 pt-8">
            {/* Ícone animado */}
            ...
            {/* Mensagem */}
            <div className="rounded-2xl bg-white/70 dark:bg-zinc-800/70 backdrop-blur-sm border border-amber-200/60 dark:border-amber-700/30 p-4 text-center shadow-sm">
              ...
              <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
                O app é <strong className="text-amber-600 dark:text-amber-400">100% gratuito</strong> e qualquer contribuição ajuda a manter e evoluir a plataforma para toda a comunidade catequética.
              </p>
            </div>

            {/* Seção Pix */}
            <div className="w-full rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 p-0.5 shadow-lg shadow-amber-400/30">
            ...
            {/* Rodapé */}
            <p className="text-[11px] text-center text-muted-foreground font-medium pb-1">
