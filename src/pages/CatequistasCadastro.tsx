                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {(item as any).isShared && (
                        <span className="flex items-center gap-0.5 text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full bg-amber-100 text-amber-700 border border-amber-200 shrink-0">
                ...
                <div className="px-5 pb-5 space-y-2">
                  {(viewItem as any).isShared ? (
                    <div className="flex items-center gap-2 p-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-700">
                      ...
                      <p className="text-xs font-semibold">Registro compartilhado. Apenas visualização.</p>
                    </div>
                  ) : (
                    <>
                      <button
