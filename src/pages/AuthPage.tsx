          ...
          <div className="w-full max-w-sm">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-sky-50 px-2 text-slate-400 font-bold tracking-widest">Ou continue com</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full h-13 flex items-center justify-center gap-3 bg-white border-2 border-slate-100 rounded-2xl font-bold text-slate-700 hover:bg-slate-50 active:scale-[0.98] transition-all shadow-sm disabled:opacity-60"
            >
