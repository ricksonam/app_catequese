...
export default function TurmaForm() {
  ...
  const handleSave = async () => {
    if (!form.nome || !form.diaCatequese || !form.horario || form.catequistasIds.length === 0) {
      toast.error("Preencha todos os campos obrigatórios (nome, dia, horário, catequista)"); return;
    }
  ...
  return (
    <div className="space-y-6 pb-10">
        ...
        <div className="bg-white rounded-3xl border-2 border-zinc-800 shadow-sm overflow-hidden animate-float-up" style={{ animationDelay: '100ms' }}>
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <select value={form.comunidadeId} onChange={(e) => update("comunidadeId", e.target.value)} className="form-input h-11 bg-white">
                <option value="">Selecione...</option>
      ...
      <button
        onClick={handleSave}
        disabled={mutation.isPending || !form.nome || !form.diaCatequese || !form.horario || form.catequistasIds.length === 0}
