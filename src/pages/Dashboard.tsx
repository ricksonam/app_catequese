            ...
            {proximosEncontros.map((e, i) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 animate-float-up w-full text-left transition-all active:scale-[0.98] ${isUrgent ? "float-card border-destructive/60 bg-destructive/5 relative z-10 scale-[1.02] shadow-lg shadow-destructive/10 ring-1 ring-destructive/40" : "float-card"}`}
